...
| ----------- | ------------------------------------------------------ |
| `ruby`      | 1.8.7-p375 (Ubuntu 22.04 only), 1.9.3-p551, 2.0.0-p648 |
...
The action works for most [GitHub-hosted runners](https://docs.github.com/en/actions/concepts/runners/github-hosted-runners), with exceptions as noted above.

| Operating System | Recommended                         | Other Supported Versions                                    |
| ---------------- | ----------------------------------- | ----------------------------------------------------------- |
| Ubuntu           | `ubuntu-latest` (= `ubuntu-24.04`)  | `ubuntu-22.04`                                              |
| macOS (Intel)    | `macos-15-intel`                    | `macos-14-large`, `macos-latest-large` (= `macos-15-large`) |
...
for Ubuntu and macOS (Intel) and in [windows-versions.js](windows-versions.js) for Windows.
